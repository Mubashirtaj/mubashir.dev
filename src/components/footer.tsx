...
const socials = [
  {
    label: "GitHub",
    href: "https://github.com/mubashirtaj",
    icon: (
  ...
  {
    label: "LinkedIn",
    href: "https://linkedin.com/in/mubashirtaj",
    icon: (
      <svg viewBox="0 0 16 16" width={15} height={15} fill="currentColor">
  ...
  {
    label: "Email",
    href: "mailto:mubashirtajuddin.info@email.com",
    icon: (
      <svg viewBox="0 0 16 16" width={15} height={15} fill="currentColor">
...
export default function PortfolioFooter() {
  ...
  return (
    <footer className="relative border-t-1 border-amber-50 overflow-hidden  px-6 pb-8 pt-14 md:px-12 " style={{ background: "var(--bg-color)" }}>
      {/* Top gradient border */}
      {/* <div
