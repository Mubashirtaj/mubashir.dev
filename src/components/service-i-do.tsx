    ...
    <section className="relative overflow-hidden  py-16">
      ...
      <div className="relative z-10 max-w-5xl mx-auto">
        ...
        <div className="text-center mb-14">
          <span className={cn(
            "inline-flex items-center gap-2 text-[10px] sm:text-xs font-medium uppercase tracking-widest rounded-full px-4 py-1 mb-4 border transition-all duration-300",
            isAvailable
              ? "text-[#6366f1] bg-[#4f46e5]/10 border-[#6366f1]/30"
              : "text-red-500 bg-orange-500/10 border-slate-500/20"
          )}>
            <span className={cn(
